...
import static test.ShaderSPIRVUtils.ShaderKind.FRAGMENT_SHADER;
import static test.ShaderSPIRVUtils.ShaderKind.VERTEX_SHADER;
import static test.ShaderSPIRVUtils.compileShaderFile;
    ...
    private static class HelloTriangleApplication {
        ...
        private void createInstance() {
            ...
            try (MemoryStack stack = stackPush()) {
                ...
                if (result != VK_SUCCESS) {
                    throw new RuntimeException("Failed to create instance: " + result);
                }
        ...
        private void createSwapChain() {
            ...
            try (MemoryStack stack = stackPush()) {
                ...
                IntBuffer imageCount = stack.ints(swapChainSupport.capabilities.minImageCount() + 2);
